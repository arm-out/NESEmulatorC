...
class nes2C02 {
    ...
    private:
        ...
        uint8_t patternTable[2][4096];      // Pattern Table
        uint8_t paletteTable[32];           // Palette Table
        ...
        // Loopy Register Struct from NesDev Wiki
        ...
        // Misc
        uint8_t address_latch = 0x00;       // Hi/Lo Byte latch
